...
const ReviewConsent = ({ formData, handleInputChange, onSubmit }) => {
    ...
    const setupDirectDebit = async () => {
        ...
        try {
            ...
            // console.log(term)
            // const mandateAmount = (amount / term) * 100;
            // console.log(mandateAmount)

            // const minimumDebit = mandateAmount / 2;
            // const num = 1;
            // const initialKobo = kobo / 6;
            // const amount = parseFloat(formData.loanAmount.replace(/,/g, ''));
            // const kobo = amount * 100;
            const startDate = getStartDate();
            const endDate = getLoanEndDate();
            ...
            // const mandateAmount = parseFloat(formData.monthlyPayment) * 100;  
            const mandateAmount = parseFloat(formData.monthlyPayment.replace(/,/g, '')) * 100;

            console.log(mandateAmount)

            const minimumDebit = mandateAmount / 2;
            // const initialKobo = mandateAmount / 2;
            const initialDebitAmountKobo = mandateAmount;
            console.log(initialDebitAmountKobo)
